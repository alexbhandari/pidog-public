...
- [ ] **Inc 3:** mover interface (**curve-based** commands for the dog's shallow turns) + **always-on reactive STOP** + turning-radius/speed calibration
- [ ] **Inc 4:** A\* planning → **drivable arcs** (min turning radius) with **safety inflation**
- [ ] **Inc 5:** **autonomous (frontier) exploration** with **look-around** (forward-FOV-aware; won't quit with space unseen behind it)
- [ ] **Inc 6:** reactive **replan + BACK-UP handler** (dead-ends / no forward escape) + COLLISION log
